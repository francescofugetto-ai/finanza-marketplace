...
description: "Valuta SINGOLE AZIENDE QUOTATE con il DCF e il reverse DCF: quali ipotesi il prezzo di mercato stia già scontando. Usala quando si valuta un'azienda quotata, se ne calcola il valore intrinseco, si legge una relazione annuale, o si chiede «con quali ipotesi si giustifica questa quotazione». NON si attiva per: asset allocation, ribilanciamento, scelta o confronto fra ETF, allocazione di un PAC o di un versamento straordinario, profilazione di un investitore o di un cliente, rendimento atteso di un portafoglio, titoli di Stato, asset che non siano azioni di società (criptovalute, materie prime, oro, immobili), distillazione di articoli, newsletter o notizie. La domanda «questo strumento serve al mio scopo» è di analisi-documenti-investimento; qui si risponde solo a «quanto vale». Non entra nelle sessioni di allocazione, non decide mai pesi di portafoglio e non genera trigger di ribilanciamento."
---
